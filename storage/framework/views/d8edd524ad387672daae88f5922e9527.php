              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    ...
                    <input type="text" name="checkin_date" id="checkin_date" class="form-control" autocomplete="off">
                  </div>  
                </div>
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input type="text" name="checkout_date" id="checkout_date" class="form-control" autocomplete="off">
                  </div>
                </div>
                ...
                <?php if(session()->has('error1')): ?>
                 <span style="margin-left: 3%; margin-left: 3%; font-size:12px; color:crimson;">
...
</html><?php /**PATH /home/samia/MyProjects/HotelManagement/resources/views/home.blade.php ENDPATH**/ ?>