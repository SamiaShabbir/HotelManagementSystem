<header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.html">Hotel Management</a></div>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="<?php echo e(route('ShowAllRooms')); ?>">Rooms</a></li>
                        <?php if(Auth::check()): ?>
                         <li><a href="<?php echo e(route('MyReservation')); ?>">My Reservation</a></li>
...
const logoutButtonStates = {
  ...
  'falling3': {
    ...
    </header><?php /**PATH /home/samia/MyProjects/HotelManagement/resources/views/includes/sidebar.blade.php ENDPATH**/ ?>