    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
            ...
            <div class="field-icon-wrap">
                ...
                <input type="text" name="checkin_date" id="checkin_date" class="form-control" value="{{ old('checkin_date') }}">
            </div>  
        </div>
        <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
            ...
            <div class="field-icon-wrap">
                <div class="icon"><span class="icon-calendar"></span></div>
                <input type="text" name="checkout_date" id="checkout_date" class="form-control" value="{{ old('checkout_date') }}">
            </div>
        </div>
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="field-icon-wrap">
                        ...
                        <select name="person" id="adults" class="form-control">
                            ...
                            <option value="3" {{ old('person') == '3' ? 'selected' : '' }}>3</option>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
            @if($room->availability==0)
                <a href="{{ url('reserve-room', ['id' => $room->id]) }}" class="room">
            @else
                <a href="" class="room">
            @endif
